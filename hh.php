...
class Affiliate_Profit_System 
{
     ...
     * @param array $config_cap - Cấu hình [cap1, chia_cap2, chia_cap3]
     */
    public function __construct($doanh_thu, $phan_tram_thue, $config_cap = [80, 50, 30]) 
    {
    ...
    {
        list($cap1, $chia_cap2, $chia_cap3) = $this->config_cap;
        $cap0 = 100 - $cap1;
