...
if ($error) {
    ...
    ?>
    <script>
        window.location.href = "<?=set_route_to_link(["public","edu_tier","tier_5",$user_id])?>";
    </script>
    <?php
} else {
?>
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex">
                        ...
                        <!-- <button type="button" class="btn btn-outline-success me-2 border-2" id="btn_export_excel" onclick="exportTableToExcel('table_lists', 'danh_sach_hoc_vien')">
                        ...
                        <div class="input-group" style="width: 280px;">
                            ...
                            <input type="text" class="form-control border-start-0" id="table_search" placeholder="Tìm kiếm học viên...">
...
function exportTableToExcel(tableID, filename = '') {
    ...
    try {
        // Method 1: Using SheetJS library if available
        if (typeof XLSX !== 'undefined') {
            ...
            // Method 2: Fallback to HTML table export
