...
function update_database() {
    ...
    elm_name.html('Đang xử lý...');
    $.ajax({
        url: "<?=set_route_to_link(["backend","edu_tier","update_info_tier_3"])?>",
        type: "POST",
        data: {
            id: archive_id,
            name: name,
        ...
        success: function(response) {
            if (response.stt) {
                $.toast({
                    heading: 'Thành công',
                    text: 'Cập nhật giảng viên thành công.',
                    icon: 'success',
                    position: 'top-right',
                    hideAfter: 5000
                });
...
function update_password() {
    ...
    elm_name.html('Đang xử lý...');
    $.ajax({
        url: "<?=set_route_to_link(["backend","edu_tier","update_password_tier_3"])?>",
        type: "POST",
        data: {
            id: archive_id,
            password: password,
