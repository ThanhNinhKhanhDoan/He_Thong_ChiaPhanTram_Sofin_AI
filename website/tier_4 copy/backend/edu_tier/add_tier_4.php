...
$dataAdmin = $is_login_tier_4->is_user();
if (!$dataAdmin) {
    ...
    if (count($error) > 0) {
        ...
        $discount_percent = $data_tier_3['discount_percent'];
        $software_discount_percent = $data_tier_3['software_discount_percent'];
        $channel_revenue_discount_percent = $data_tier_3['channel_revenue_discount_percent'];
