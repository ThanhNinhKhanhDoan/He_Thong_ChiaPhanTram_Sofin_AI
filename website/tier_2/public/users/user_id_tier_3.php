...
if ($datas == 0) {
    ?>
    <script>
        window.location.href = "<?=set_route_to_link(["public","users","tier_1"])?>";
    </script>
    <?php
} else {
    ...
    $data_live_2s = $db->findOne("users", ["tier_level" => "", "email" => $dataUsers["tier_level"]]);
    $data_live_2s = $data_live_2s[0];
    ?>
            ...
            <div class="col">
                ...
                <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
                    <ul class="breadcrumb pt-0">
                        ...
                        <li class="breadcrumb-item"><a href="<?=set_route_to_link(["public","users","tier_1"])?>">Tier 1</a>
                        </li>
                        <li class="breadcrumb-item"><a href="<?=set_route_to_link(["public","users","user_id_tier_2"])?>/<?=$data_live_2s["_id"]->__toString()?>">Tier 2</a>
                        </li>
                        <li class="breadcrumb-item"><a href="<?=set_route_to_link(["public","users","user_id_tier_3"])?>/<?=$u_id?>">Tier 3</a>
                        </li>
                    </ul>
                </nav>
            </div>
                            ...
                            <form>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="role3">Distributor (Tier 1)</label>
                                    </div>
                                    <div class="form-check">
