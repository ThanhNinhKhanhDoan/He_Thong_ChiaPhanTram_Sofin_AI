...
<?php
$error = false;
$tier_2_id =  $dataUsers["_id"]->__toString();;
...
$percent_user_discount = intval($data_tier_2["discount_percent"]) - 1;
$percent_user_software_discount = intval($data_tier_2["software_discount_percent"]) - 1;
$percent_user_channel_revenue_discount = intval($data_tier_2["channel_revenue_discount_percent"]) - 1;
...
if ($error) {
    ?>
    <script>
        window.location.href = "<?=set_route_to_link(["public","edu_tier","tier_2",$tier_1_id])?>";
    </script>
    <?php
} else {
?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createCategoryModalLabel">Tạo giảng viên</h5>
            ...
            <div class="modal-body">
                <input type="hidden" id="tier_2_id" value="<?=$tier_2_id?>">
                ...
                <div class="mb-3 filled">
                    ...
                    <input class="form-control" id="name" placeholder="Nhập tên giảng viên">
                </div>
                <div class="mb-3 filled">
                ...
                <div class="mb-1 filled">
                    <small class="text-primary bg-light p-2 rounded d-block mt-2" style="border-left: 4px solid #0d6efd;">
                            ...
                            Nhập tỷ lệ % hoa hồng "<span class='text-success'>khoá học</span>" bạn muốn chia xuống cho cấp dưới (tối đa <?=$percent_user_discount?>%)
                    </small>
                </div>
                ...
                <div class="mb-1 filled">
                    <small class="text-primary bg-light p-2 rounded d-block mt-2" style="border-left: 4px solid #0d6efd;">
                            <i class="fas fa-info-circle me-2"></i>
                            Nhập tỷ lệ % hoa hồng "<span class='text-success'>phần mềm</span>" bạn muốn chia xuống cho cấp dưới (tối đa <?=$percent_user_software_discount?>%)
                    </small>
                </div>
                ...
                <div class="mb-1 filled">
                    <small class="text-primary bg-light p-2 rounded d-block mt-2" style="border-left: 4px solid #0d6efd;">
                            <i class="fas fa-info-circle me-2"></i>
                            Nhập tỷ lệ % hoa hồng "<span class='text-success'>kênh</span>" bạn muốn chia xuống cho cấp dưới (tối đa <?=$percent_user_channel_revenue_discount?>%)
                    </small>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3 filled">
                    ...
                    <input type="number" class="form-control" id="edit_discount_percent" placeholder="% chiết khấu khoá học" min="0" max="100">
                </div>
                <div class="mb-3 filled">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="acorn-icons acorn-icons-percent">
                        <path d="M5 15L15 5M7.5 5C6.11929 5 5 6.11929 5 7.5C5 8.88071 6.11929 10 7.5 10C8.88071 10 10 8.88071 10 7.5C10 6.11929 8.88071 5 7.5 5ZM12.5 10C11.1193 10 10 11.1193 10 12.5C10 13.8807 11.1193 15 12.5 15C13.8807 15 15 13.8807 15 12.5C15 11.1193 13.8807 10 12.5 10Z"></path>
    ...
    <div class="page-header">
        ...
        <div class="alert alert-warning mb-3" role="alert">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h5 class="alert-heading mb-1">Chào mừng bạn đến trang quản lý <span class="text-primary" style="font-weight: 900; font-size: 1.2rem;">"Cấp Giảng Viên"</span> đây là phiên bản basic.</h5>
                        ...
                        <div class="glide__slide col-12 col-sm-6 col-md-4 col-lg-2">
                            <div class="card mb-5 hover-border-primary">
                                <div class="h-100 d-flex flex-column justify-content-between card-body align-items-center">
                                    ...
                                    <div class="display-6 text-primary"><?=$data_tier_2["discount_percent"]?>%</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="glide__slide col-12 col-sm-6 col-md-4 col-lg-2">
                            <div class="card mb-5 hover-border-primary">
                                <div class="h-100 d-flex flex-column justify-content-between card-body align-items-center">
                                    ...
                                    <div class="display-6 text-primary"><?=$data_tier_2["software_discount_percent"]?>%</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="glide__slide col-12 col-sm-6 col-md-4 col-lg-2">
                            <div class="card mb-5 hover-border-primary">
                                <div class="h-100 d-flex flex-column justify-content-between card-body align-items-center">
                                    ...
                                    <div class="display-6 text-primary"><?=$data_tier_2["channel_revenue_discount_percent"]?>%</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="glide__slide col-12 col-sm-6 col-md-4 col-lg-2">
                            <div class="card mb-5 hover-border-primary">
                                <div class="h-100 d-flex flex-column justify-content-between card-body align-items-center">
                                    ...
                                    <div class="display-6 text-primary"><?=$data_tier_2["count_tier_3"]?></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="glide__slide col-12 col-sm-6 col-md-4 col-lg-2">
                            <div class="card mb-5 hover-border-primary">
                                <div class="h-100 d-flex flex-column justify-content-between card-body align-items-center">
                                    ...
                                    <div class="display-6 text-primary"><?=$data_tier_2["count_tier_4"]?></div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title">
                        <i class="fas fa-folder"></i> Danh sách giảng viên
                    </h5>
                    <div class="d-flex">
                        <button type="button" class="btn btn-outline-primary me-2 border-2" id="btn_create_cate" data-bs-toggle="modal" data-bs-target="#createCategoryModal">
                            <i class="fas fa-plus-circle"></i> Tạo giảng viên
                        </button>
                ...
                <div class="card-body border-bottom bg-light py-2">
                    <div class="d-flex align-items-center justify-content-between flex-wrap">
                        ...
                        <button type="button" class="btn btn-success btn-sm btn-xs" id="btn_active_selected" onclick="table_update_status('active',{elm_table_id: 'table_lists', checkboxName: 'table_checkbox', elm_id_btn_active_selected: 'btn_active_selected', elm_id_btn_pending_selected: 'btn_pending_selected', elm_id_btn_delete_selected: 'btn_delete_selected', url_update_status : '<?=set_route_to_link(["backend","edu_tier","update_status_tier_3"])?>'})">
                            <i class="fas fa-trash-restore"></i> Kích hoạt
                        </button>
                        <button type="button" class="btn btn-success btn-sm btn-xs" id="btn_pending_selected" onclick="table_update_status('pending',{elm_table_id: 'table_lists', checkboxName: 'table_checkbox', elm_id_btn_active_selected: 'btn_active_selected', elm_id_btn_pending_selected: 'btn_pending_selected', elm_id_btn_delete_selected: 'btn_delete_selected', url_update_status : '<?=set_route_to_link(["backend","edu_tier","update_status_tier_3"])?>'})">
                            <i class="fas fa-clock"></i> Chuyển sang chờ duyệt
                        </button>
                        <button type="button" class="btn btn-danger btn-sm btn-xs" id="btn_delete_selected" onclick="table_update_status('deleted',{elm_table_id: 'table_lists', checkboxName: 'table_checkbox', elm_id_btn_active_selected: 'btn_active_selected', elm_id_btn_pending_selected: 'btn_pending_selected', elm_id_btn_delete_selected: 'btn_delete_selected', url_update_status : '<?=set_route_to_link(["backend","edu_tier","update_status_tier_3"])?>'})">
