    ...
    if (count($error) > 0) {
        ...
        if (count($error) > 0) {
            ...
            $datas = [
                ...
                "discount_percent" => intval($discount_percent_user),
                "software_discount_percent" => intval($software_discount_percent_user),
                "channel_revenue_discount_percent" => intval($channel_revenue_discount_percent_user),
                "tier_1_id" => $tier_1_id,
                "tier_2_id" => $tier_2_id,
                "tier_3_id" => $tier_3_id,
                "count_ref_level" => 0,
