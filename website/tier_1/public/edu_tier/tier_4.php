...
$percent_user_discount = intval($data_tier_3["discount_percent"]) - 1;
$percent_user_software_discount = intval($data_tier_3["software_discount_percent"]) - 1;
$percent_user_channel_revenue_discount = intval($data_tier_3["channel_revenue_discount_percent"]) - 1;
                        ...
                        <div class="glide__slide col-12 col-sm-6 col-md-4 col-lg-2">
                            <div class="card mb-5 hover-border-primary">
                                <div class="h-100 d-flex flex-column justify-content-between card-body align-items-center">
                                    ...
                                    <div class="display-6 text-primary"><?=$data_tier_3["discount_percent"]?>%</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="glide__slide col-12 col-sm-6 col-md-4 col-lg-2">
                            <div class="card mb-5 hover-border-primary">
                                <div class="h-100 d-flex flex-column justify-content-between card-body align-items-center">
                                    ...
                                    <div class="display-6 text-primary"><?=$data_tier_3["software_discount_percent"]?>%</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="glide__slide col-12 col-sm-6 col-md-4 col-lg-2">
                            <div class="card mb-5 hover-border-primary">
                                <div class="h-100 d-flex flex-column justify-content-between card-body align-items-center">
                                    ...
                                    <div class="display-6 text-primary"><?=$data_tier_3["channel_revenue_discount_percent"]?>%</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="glide__slide col-12 col-sm-6 col-md-4 col-lg-2">
                            <div class="card mb-5 hover-border-primary">
                                <div class="h-100 d-flex flex-column justify-content-between card-body align-items-center">
                                    ...
                                    <div class="display-6 text-primary"><?=$data_tier_3["count_tier_4"]?></div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title d-flex align-items-center">
                        ...
                        <span class="fw-bold mb-0" style="font-size: 1.2rem; color: #a6d0d7; text-transform: uppercase; letter-spacing: 0.5px;">Danh sách học viên</span>
                    </h5>
                    <div class="d-flex">
