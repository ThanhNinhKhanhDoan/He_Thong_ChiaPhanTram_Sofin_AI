<?php
    ...
    $dulieu = $db->findOneId("tests3", $params[3]);
    $dulieu = $dulieu[0];
?>
        ...
        <div class="col-md-8 offset-md-2">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <input type="hidden" id="id" value="<?=$dulieu['_id']->__toString()?>">
                    
                    
                    <div class="text-center mt-4">
                        <button class="btn btn-warning" onclick="edit3()">Cập nhật thông tin</button>
                        <a href="<?=set_route_to_link(["public","test3","index"])?>" class="btn btn-secondary">Quay lại</a>
                    </div>
                </div>
            </div>
        </div>
