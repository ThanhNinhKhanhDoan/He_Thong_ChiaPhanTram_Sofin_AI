    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createCategoryModalLabel">Tạo cấp 1</h5>
            ...
            <div class="modal-body">
                <div class="mb-3 filled">
                    ...
                    <input class="form-control" id="name" placeholder="Nhập tên cấp 1">
                </div>
                <div class="mb-3 filled">
...
<div class="container-fluid">
    ...
    <div class="page-header">
        <h1 class="page-title">Quản lý tổ chức</h1>
    </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title">
                        <i class="fas fa-folder"></i> Danh sách tổ chức
                    </h5>
                    <div class="d-flex">
                        <button type="button" class="btn btn-outline-primary me-2 border-2" id="btn_create_cate" data-bs-toggle="modal" data-bs-target="#createCategoryModal">
                            <i class="fas fa-plus-circle"></i> Tạo tổ chức
                        </button>
